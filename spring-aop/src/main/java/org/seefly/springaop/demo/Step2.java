...
public class Step2 {
    ...
    public static class Config{
        ...
        public AfterReturningAdvice afterAdvice(){
            return (returnValue, method, args, target) -> System.out.println("方法"+ method.getName()+"执行完毕，返回值"+returnValue);
        }
        @Bean
        public MethodBeforeAdvice beforeAdvice(){
            return (method, args, target) -> System.out.println("准备执行方法"+method.getName()+" 参数列表"+ Arrays.toString(args));
        }
