...
import org.seefly.aop.basic.evolution.advice.LogAfterAdvice;
import org.seefly.aop.basic.evolution.advice.LogBeforeAdvice;
...
public class Step1 {
    ...
    public static class Config {
        ...
        public ProxyFactoryBean userServiceProxy() throws ClassNotFoundException {
            ...
            // 指定代理的接口 可以是多个
            Class<UserService>[] arr = new Class[]{UserService.class};
