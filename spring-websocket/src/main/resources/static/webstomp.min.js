(function (global, factory) {
    ...
    var PROTOCOLS_VERSIONS = {"v10.stomp": VERSIONS.V1_0, "v11.stomp": VERSIONS.V1_1, "v12.stomp": VERSIONS.V1_2};
    ...
    var Frame = function () {
        ...
        createClass(Frame, [{
            ...
            key: "unmarshallSingle", value: function unmarshallSingle(data) {
                var divider = data.search(new RegExp(BYTES.LF + BYTES.LF)),
                    headerLines = data.substring(0, divider).split(BYTES.LF), command = headerLines.shift(),
                    headers = {}, body = "", bodyIndex = divider + 2;
            ...
            key: "unmarshall", value: function unmarshall(datas) {
                var frames = datas.split(new RegExp(BYTES.NULL + BYTES.LF + "*")), firstFrames = frames.slice(0, -1),
                    lastFrame = frames.slice(-1)[0], r = {
            ...
            key: "marshall", value: function marshall(command, headers, body) {
    ...
    var Client = function () {
        function Client(ws) {
            ...
            var _options$binary = options.binary, binary = _options$binary === undefined ? false : _options$binary,
                _options$heartbeat = options.heartbeat,
                heartbeat = _options$heartbeat === undefined ? {outgoing: 1e4, incoming: 1e4} : _options$heartbeat,
                _options$debug = options.debug, debug = _options$debug === undefined ? true : _options$debug,
        ...
        createClass(Client, [{
            ...
            key: "connect", value: function connect() {
                ...
                var _parseConnect2 = this._parseConnect.apply(this, arguments),
                    _parseConnect3 = slicedToArray(_parseConnect2, 3), headers = _parseConnect3[0],
                    connectCallback = _parseConnect3[1], errorCallback = _parseConnect3[2];
            ...
            key: "disconnect", value: function disconnect(disconnectCallback) {
                var headers = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
            ...
            key: "send", value: function send(destination) {
            ...
            key: "commit", value: function commit(transaction) {
                this._transmit("COMMIT", {transaction: transaction})
            }
        }, {
            key: "abort", value: function abort(transaction) {
                this._transmit("ABORT", {transaction: transaction})
            }
        }, {
            key: "ack", value: function ack(messageID, subscription) {
                var headers = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
                var hdrs = Object.assign({}, headers);
            ...
            key: "nack", value: function nack(messageID, subscription) {
                var headers = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
                var hdrs = Object.assign({}, headers);
                var idAttr = this.version === VERSIONS.V1_2 ? "id" : "message-id";
                hdrs[idAttr] = messageID;
            ...
            key: "subscribe", value: function subscribe(destination, callback) {
                var headers = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
                var hdrs = Object.assign({}, headers);
                ...
                return {id: hdrs.id, unsubscribe: this.unsubscribe.bind(this, hdrs.id)}
            }
        }, {
            key: "unsubscribe", value: function unsubscribe(id) {
                var headers = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                var hdrs = Object.assign({}, headers);
            ...
            key: "_setupHeartbeat", value: function _setupHeartbeat(headers) {
                var _this2 = this;
                ...
                var _split$map = (headers["heart-beat"] || "0,0").split(",").map(function (v) {
                    ...
                    }), _split$map2 = slicedToArray(_split$map, 2), serverOutgoing = _split$map2[0],
            ...
            key: "_parseConnect", value: function _parseConnect() {
    ...
    var webstomp = {
        Frame: Frame, VERSIONS: VERSIONS, client: function client(url) {
            var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
